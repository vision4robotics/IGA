...
from attack_utils_dasiamrpn import adv_attack_search
from data_utils import tensor2img
from snot.utils.utils_ad import get_subwindow_tracking
import os
import cv2
...
def SiamRPN_track(state, im, GAN, save_path=None, frame_id=None):
    p = state['p']
    net = state['net']
