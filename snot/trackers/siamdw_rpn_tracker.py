...
from snot.utils.utils_dw import load_yaml, get_subwindow_tracking, python2round, generate_anchor
from attack_utils.attack_utils_dw_rpn import adv_attack_search
...
class SiamRPN(object):
    ...
    def track(self, state, im, GAN, save_path=None, frame_id=None):
        p = state['p']
        net = state['net']
        ...
        x_crop = adv_attack_search(x_crop.cuda(), GAN, (x_crop.shape[2], x_crop.shape[3]))
